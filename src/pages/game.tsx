...
function GamePage() {
    /* Potential Ideas:
        Chess vs a bot
        Monty Hall problem + track percentages
        Minesweeper
        3d looking Rock Paper Scissors vs a bot
        Chatbot - who really really wants you to hire me - maybe put this elsewhere too
    */
    return (
        <div className="GamePage">
                <div className="content">
                    <div className="bubble-container game">
