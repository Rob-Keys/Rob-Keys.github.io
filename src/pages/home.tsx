    ...
    return (
        <div className="HomePage">
            ...
            <div className="highlights-grid">
                <a href="/resume" className="highlight-card card bubble-container" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://virginiasports.com/sports/football/roster/season/2025-26/player/rob-keys/" className="highlight-card card bubble-container" target="_blank" rel="noopener noreferrer">
                    <div className="highlight-icon">⚡</div>
                ...
                <a href="https://github.com/Rob-Keys" className="highlight-card card bubble-container" target="_blank" rel="noopener noreferrer">
                    <div className="highlight-icon">💻</div>
            ...
            <div className="about-section">
                <div className="motives bubble-container">
